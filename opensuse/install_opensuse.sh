...
echo "[*] Installing Hyprland and required tools on openSUSE..."

sudo zypper refresh
sudo zypper install -y git gcc make hyprland waybar rofi kitty thunar btop cava swappy fastfetch wlogout sddm kvantum qt5ct qt6ct
...
echo "[✓] Hyprland and your full config are installed on openSUSE!"

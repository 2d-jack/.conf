...
echo "[*] Installing Hyprland and required tools on Arch..."

sudo pacman -Syu --noconfirm
sudo pacman -S --noconfirm git base-devel hyprland waybar rofi kitty thunar btop cava swappy fastfetch wlogout sddm kvantum qt5ct qt6ct
...
echo "[✓] Hyprland and your full config are installed on Arch!"
